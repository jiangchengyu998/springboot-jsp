					...
					<div class="row">
						<div class="col-lg-6">
							<div class="about-image">
								<a href="#"><img src="assets/images/about/about-1.jpg"
									alt=""></a> <span class="text_left">Welcome To
									OrangeSchool</span>
							</div>
						...
						<div class="col-lg-6">
							<div class="about-contents">
								<h3>简概</h3>
								<p>橙子校园是一个高校校园综合性的二手交易平台，同时也是一个高校学生低碳环保绿色生活平台。在以通过向学生提供免费的信息发布平台，
									有针对性的发布和获取信息为底层生态的基础上，引入社会二手学生商家，建立校园二手的校园二手商城。学生可以通过线上或线下进行买
									卖。培养激励广大高校学生绿色环保生活方式，大力推动高校环保事业的发展。</p>
							</div>
						</div>
					</div>
				</div>
					...
					<div class="product-warpper">
						<div class="product-slider row">
							<div class="col">
								...
								<div class="single-product-wrap">
									<div class="product-image">
										<a href="#"><img src="assets/images/head/xzl.jpg" alt=""></a>
										<div class="product-action"></div>
									</div>
									<div class="product-content">
										<h3>徐志龙</h3>
										<div class="price-box">
											<span class="new-price">前端攻城狮</span>
										</div>
									</div>
								</div>
							...
							<div class="col">
								...
								<div class="single-product-wrap">
									<div class="product-image">
										<a href="#"><img src="assets/images/head/hjh.jpg" alt=""></a>
										<div class="product-action"></div>
									</div>
									<div class="product-content">
										<h3>洪佳辉</h3>
										<div class="price-box">
											<span class="new-price">后端程序猿</span>
										</div>
									</div>
								</div>
								<!-- single-product-wrap end -->
							...
							<div class="col">
								...
								<div class="single-product-wrap">
									<div class="product-image">
										<a href="#"><img src="assets/images/head/lc.jpg" alt=""></a>
										<div class="product-action"></div>
									</div>
									<div class="product-content">
										<h3>梁晨</h3>
										<div class="price-box">
											<span class="new-price">运营和推广</span>
										</div>
									</div>
								</div>
								<!-- single-product-wrap end -->
								...
								<div class="single-product-wrap">
									<div class="product-image">
										...
										<div class="product-action">
											<a href="#" class="wishlist"><i class="icon-heart"></i></a> <a
												href="#" class="add-to-cart"><i class="icon-handbag"></i></a>
