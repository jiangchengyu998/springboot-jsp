	...
	<div class="main-wrapper">
		...
		<div class="breadcrumb-area section-ptb">
			<div class="container">
				<div class="row">
					<div class="col">
						<h2 class="breadcrumb-title">求购</h2>
						<!-- breadcrumb-list start -->
						<ul class="breadcrumb-list">
							<li class="breadcrumb-item"><a
								href="oneusergood?gouwu=zhuye">主页</a></li>
							<li class="breadcrumb-item active">求购</li>
						</ul>
						<!-- breadcrumb-list end -->
					</div>
				</div>
					...
					<div class="col-lg-8 offset-lg-2">
						...
						<div class="blog-wrapper">
							...
							<div class="blog-wrap">
								...
								<c:forEach items="${pc.list}" var="purchase">
										...
										<div class="blog-contend">
											...
											<div class="blog-date-categori">
												...
												<ul>
													...
													<li>时间：<fmt:formatDate pattern="yyyy-MM-dd HH:mm:ss"
															value="${purchase.prelease}" type="both" /></li>
													<br />
                                ...
                                <div class="blog-image-slider">
                                    <a href="blog-details.jsp"><img src="assets/images/blog/3.jpg" alt=""></a>
                                    <a href="blog-details.jsp"><img src="assets/images/blog/1.jpg" alt=""></a>
                                    <a href="blog-details.jsp"><img src="assets/images/blog/4.jpg" alt=""></a>
                                </div>
                                <div class="blog-contend">
                                    <h3><a href="#">学前教育专业书</a></h3>
                                    <div class="blog-date-categori">
                                        <ul>
                                            <li><a href="#"><i class="ion-ios-person"></i>黄同学</a></li>
                                            <li><a href="#"><i class="ion-ios-pricetags"></i>未认证</a></li>
                                            <li>时间：2018年10月15日</li><br />
                                            <li>价格：300.00</li><br />
                                            <li>学校：厦门大学</li><br />
                                            <li>手机：18106937860</li><br />
                                            <li>qq/微信：858887164</li><br />
                                            <li>交易地点：图书馆门口</li>
                                        </ul>
                                    </div>
                                    <p>有关学前教育专业书的全部教材，急需！</p>
                                    <div class="mt-30 blog-more-area">
                                        <ul class="social-icons">
                                            <li><a href="#"><i class="ion-social-facebook"></i></a></li>
                                            <li><a href="#"><i class="ion-social-twitter"></i></a></li>
                                ...
                                <div class="col-lg-6 col-md-6">
                                    <ul class="pagination-box">
                                     <li>
                                        ...
                                        <a class="Previous" href="oneusergood?gouwu=buy">首页</a>
                                        
                                        </li>
                                        <li><c:if test="${pc.hasPreviousPage}">
                                        <a class="Previous" href="oneusergood?gouwu=buy&pageNo=${pc.prePage}">上一页</a>
                                        </c:if>
                                        </li>
                                        <li class="active"><c:if test="${pc.hasPreviousPage}">
    	                                <a href="oneusergood?gouwu=buy&pageNo=${pc.prePage}">${pc.prePage}</a>
    	                                                           </c:if></li>
                                        <li><span>${pc.pageNum}</span></li>
                                        <li><c:if test="${pc.hasNextPage}">
    	                                 <a href="oneusergood?gouwu=buy&pageNo=${pc.nextPage}">${pc.nextPage}</a>
    	                                 </c:if></li>
                                        <li>
                                          <c:if test="${pc.hasNextPage}">
                                          <a class="Next" href="oneusergood?gouwu=buy&pageNo=${pc.nextPage}">下一页</a>
                                          </c:if>
                                        </li>
                                         <li>
                                        	<a href="oneusergood?gouwu=buy&pageNo=${pc.pages}">尾页</a>
                                        </li>
                                    </ul>
                                </div>
                            </div>
                    ...
                    <div class="col-lg-4 col-md-12">
                        <div class="footer-info mt--60">
                            ...
                            <ul class="footer-info-list">
                                <li>
                                    <i class="ion-ios-location-outline"></i> 地址：福建省厦门市集美区软件园三期D03
                                </li>
                                <li>
                                    <i class="ion-ios-email-outline"></i>邮箱：xzl897@sina.com</a>
                                </li>
                                <li>
                                    <i class="ion-ios-telephone-outline"></i>电话：15659982829
                                </li>
                            </ul>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-6  col-md-6"><div class="copyright">
                        <p>Copyright ©All Right <a href="http://www.17sucai.com/">reserved</a>.</p>
                    </div></div>
                    <div class="col-lg-6 col-md-6">
