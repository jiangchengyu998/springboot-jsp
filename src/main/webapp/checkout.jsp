	...
	<div class="main-wrapper">
		...
		<div class="breadcrumb-area section-ptb">
			<div class="container">
				<div class="row">
					<div class="col">
						<h2 class="breadcrumb-title">订单</h2>
						...
						<div class="col-lg-6 col-md-6">
							...
							<div class="billing-details-wrap">
								<form action="addorder" method="post">
									<h3 class="shoping-checkboxt-title">详细地址</h3>
									<div class="row">
										<div class="col-lg-6">
										...
										<div class="col-lg-6">
											<p class="single-form-row">
												<label>qq / 微信</label> <input type="text" name="oqqorweixin">
											</p>
										</div>
									</div>
									...
									<div class="your-order-table table-responsive">
										<table>
											...
											<tbody>
												<c:forEach items="${oneuser}" var="commodity">
													<tr class="cart_item">
														<td class="product-name">${commodity.cname}</strong>
														</td>
														<td class="product-total"><span class="amount">${commodity.cprice}</span>
														</td>
													</tr>
												</c:forEach>
											...
											<tfoot>
												<tr class="order-total">
													<th>总价</th>
													<td><strong><span class="amount">￥${price}</span></strong>
													</td>
												</tr>
											</tfoot>
										</table>
