	...
	<div class="main-wrapper">
		...
		<div class="breadcrumb-area section-ptb">
			<div class="container">
				<div class="row">
					<div class="col">
						<h2 class="breadcrumb-title">发布二手</h2>
						<!-- breadcrumb-list start -->
						<ul class="breadcrumb-list">
							<li class="breadcrumb-item"><a
								href="oneusergood?gouwu=zhuye">主页</a></li>
							<li class="breadcrumb-item active">发布二手</li>
						</ul>
						<!-- breadcrumb-list end -->
					</div>
				</div>
					...
					<div class="row">
						<div class="col-lg-6 col-md-6"
							...
							<div class="billing-details-wrap">
								<form action="fabu" method="post" enctype="multipart/form-data">
									<h3 class="shoping-checkboxt-title">发布二手信息</h3>
									<div class="row">
										<div class="col-lg-6">
											<p class="single-form-row">
												<label>二手图片 <span class="required">*</span></label>
											</p>
										</div>
										<div class="col-lg-12">
											<div class="a-upload">
										...
										<div class="col-lg-12">
											<p class="single-form-row">
												<label>二手名称 <span class="required">*</span></label> <input
										...
										<div class="col-lg-12">
											<p class="single-form-row">
												<label>价格 <span class="required">*</span></label> <input
													type="text" name="cprice" onmouseout="checkprice()">
											</p>
										</div>
										...
										<div class="col-lg-6">
											<p class="single-form-row">
												<label>手机 <span class="required">*</span></label> <input
													type="text" name="ctel" onmouseout="checktel()"> <span
													id="stel"></span>
											</p>
										</div>
...
<script type="text/javascript">
	...
	function checktel() {
		...
		if (!(tel.toString().length < 12 && tel.toString().length > 10)) {

			$("#stel").html("请输入正确的电话号码");
		} else {
			$("#tel").focus();
			$("#stel").html("");
		}
